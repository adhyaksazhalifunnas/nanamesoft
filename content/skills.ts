...
export const skills: Skill[] = [
  // ── Languages ────────────────────────────────────────────────────────────
  {
    ...
    firstUsed: 2020,
    lastUsed: null,
    projects: ["frescis", "batik-anomaly-detection"],
  ...
  // ── Data & machine learning ──────────────────────────────────────────────
  {
    ...
    firstUsed: 2024,
    lastUsed: null,
    projects: ["batik-anomaly-detection"],
  ...
  // ── Practices ────────────────────────────────────────────────────────────
  {
    ...
    firstUsed: 2022,
    lastUsed: null,
    projects: ["lpg-vending-iot", "frescis"],
    note: "Team lead on the capstone and the senior project.",
    showcase: false,
  },
  {
    id: "iot-prototyping",
